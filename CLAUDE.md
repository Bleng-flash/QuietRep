...
Planned-set rep inputs are validated in two complementary layers (phase 1; `LoggedSetRow` in the live session will follow, reusing the same constant and highlight pattern):
