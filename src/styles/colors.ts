...
// The two modes the Appearance toggle switches between, and the only two palettes that exist.
// QuietRep is deliberately built around a single green identity in a dark and a light variant.
