...
import { COMPACT_INPUT_SLACK, spacing } from '@/styles';
...
const styles = StyleSheet.create({
  ...
  // Chromeless (no border or background), so it takes the compact slack token on its own —
  // the header is dense and this sits on the same tier as the set rows.
  nameInput: {
    alignSelf: 'stretch',
    textAlign: 'center',
    ...COMPACT_INPUT_SLACK,
